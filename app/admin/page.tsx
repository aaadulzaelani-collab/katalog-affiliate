...
//   // Data dummy (nanti bisa dihubungkan ke Sheets tab ke-2)
//   const [tasks, setTasks] = useState([
//     { id: 1, produk: "Keyboard Mechanical", platform: "TikTok", status: "Planning", jadwal: "15 Juni", ide: "Unboxing & ASMR" },
//     { id: 2, produk: "Mouse Gaming", platform: "Instagram", status: "Done", jadwal: "16 Juni", ide: "Spill setup meja" },
//   ]);
...
//           <h1 className="text-2xl font-black text-slate-800 uppercase tracking-tight">🚀 Content Planner</h1>
//           <span className="bg-orange-500 text-white px-4 py-1 rounded-full text-xs font-bold">Admin Only</span>
//         </header>

//         <div className="grid gap-4">
//           {tasks.map((task) => (
//             <div key={task.id} className="bg-white p-5 rounded-2xl shadow-sm border border-slate-200 flex flex-col md:flex-row md:items-center justify-between gap-4">
//               <div>
//                 <div className="flex items-center gap-2 mb-1">
//                   <span className={`text-[10px] font-bold px-2 py-0.5 rounded uppercase ${task.platform === 'TikTok' ? 'bg-black text-white' : 'bg-gradient-to-tr from-yellow-400 to-purple-600 text-white'}`}>
//                     {task.platform}
//                   </span>
//                   <span className="text-slate-400 text-xs">{task.jadwal}</span>
//                 </div>
//                 <h3 className="font-bold text-slate-800 text-lg">{task.produk}</h3>
//                 <p className="text-slate-500 text-sm italic">"{task.ide}"</p>
//               </div>

//               <div className="flex items-center gap-3">
//                 <select 
//                   className={`text-xs font-bold p-2 rounded-lg border-none ring-1 ring-slate-200 ${task.status === 'Done' ? 'bg-green-100 text-green-600' : 'bg-yellow-100 text-yellow-600'}`}
...
//                   <option>Done</option>
//                 </select>
//                 <button className="bg-slate-800 text-white p-2 rounded-lg hover:bg-orange-500 transition-colors">
...
//         <button className="mt-8 w-full py-4 bg-white border-2 border-dashed border-slate-300 rounded-2xl text-slate-400 font-bold hover:border-orange-500 hover:text-orange-500 transition-all">
